...
const body = `
<section class="atm-container hero">
  <div>
    <p class="atm-eyebrow">Senior product designer</p>
    <h1 class="t-display-l" style="margin-top:var(--space-3)">Hi, I’m Ed.</h1>
    <p class="t-body-lg" style="color:var(--ink-secondary);margin-top:var(--space-4);max-width:52ch">I bring systems thinking, empathy, and strategic clarity to help teams design smarter, build with purpose, and stay aligned. Also, I bake sourdough.</p>
